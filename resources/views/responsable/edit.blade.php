        ...
        <div
            ...
            <form action="{{ route("responsable.update", $datas) }}" method="POST" autocomplete="off"
                ...
                <div class="transition-all duration-400 w-full h-[15%] flex justify-center items-center">
                    <h2 class="transition-all duration-400 h-full flex justify-center items-center sm:text-2xl text-xl font-['papyrus']">Modifiez : <span
                            class="trasnition-all duration-400 text-emerald-400 ml-2 underline truncate">{{ $datas->prenom }}</span>
                    </h2>
                </div>
